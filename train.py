...
parser.add_argument('--model',type=str,default='CLGCN',help='model selection(CLGCN or Pretrain_GCN)')
parser.add_argument('--model1',type=str,default='None',help='model selection(CLGCN)')
parser.add_argument('--CL',type=str,default=False,help='Contrastive learning selection')
...
def main():
    ...
    if args.model=='CLGCN':
        engine = trainer1(scaler,args.in_dim, args.seq_length, args.num_nodes, args.nhid, args.dropout,args.CL,args.model1,
                         args.learning_rate, args.weight_decay, device, supports, args.weight_decay, args.clip,args.lr_decay_rate
                         )
    elif args.model=='Base_GCN':
        engine = trainer1(scaler,args.in_dim, args.seq_length, args.num_nodes, args.nhid, args.dropout,args.CL,args.model1,
                         args.learning_rate, args.weight_decay, device, supports, args.weight_decay, args.clip,args.lr_decay_rate
                         )
    ...
    if args.model1!='None':
        params_path1=args.save+"/"+args.model1
        engine.model.load_state_dict(torch.load(params_path1+"/"+args.model1+"_best"+".pth"))
    ...
    if args.CL and args.model1=='None':
        bestid = np.argmin(his_train_loss)
        print(bestid)
        ...
        print("Pretrain model training done")
        return
    else:
